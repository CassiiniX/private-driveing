    	...
    	<div class="card-body">
    		...
    		<div class="table-responsive">
	    		<table class="table mt-4">
	    			...
	    			<?php foreach($instructur as $item){ ?>
		    			<tr>
		    				<td><?= $item['id'];?></td>
		    				<td>
		    					<a href="<?= base_url('assets/images/instructurs/'.$item['photo']);?>" target="_blank">
		    				...
		    				<td>
		    					...
		    					<?php } else if($item['status'] == "nonactive"){ ?>
		    						<span class="badge badge-danger">Nonactive</span>
		    					<?php } else if($item['status'] == "hire"){ ?>
		    						<span class="badge badge-warning text-white">Tersewa</span>
		    					<?php } ?>
		    				</td>
						  ...
						  <div class="modal-dialog modal-lg" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">      
						      	<form action="<?= base_url('admin/instructur/edit/'.$item['id']);?>" method="post" 
							      	...
							      	<div class="form-group">
							      		...
							      		<small class="text-muted">Masukan Photo</small>
							      	</div>
							      	<div class="form-group">
...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">      
      	<form action="<?= base_url('admin/instructur/add');?>" 
      		method="post" 
      		id="form-add-data" 
      		enctype="multipart/form-data">
      		<?= csrf_field();?>
