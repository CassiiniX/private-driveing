...
<body>		
	<div class="container"
		...
		<div class="row mt-5">
			<div class="col-lg-4 offset-lg-2 col-xs-4 offset-xs-2 col-md-12 col-sm-12 text-center p-2">
				<img src="<?= base_url('assets/images/welcome-1.png');?>"					
					class="animated bounceIn"
					style="height:250px">
			</div>

			<div class="col-lg-4 col-xs-4 col-md-12 col-sm-12 p-2">
				...
				<form method="post" action="<?= base_url('signup');?>" id="form-signup">
					<?= csrf_field(); ?>
